...
Xperia? smartphones, tablets and accessories are packed full of intelligent Sony technology to enhance your world and get the most out of every moment that life brings. <a href="#"></a></p>
  ...
  <tr>
    <td height="404"><table width="872" border="1" align="center" bordercolor="#003399">
        <tr>
          <td width="866" height="35" align="center"><strong>PURCHASE DETAILS</strong></td>
        </tr>
        <tr>
          <td align="center"><table width="865" height="36" border="1" bordercolor="#003366">
  <tr>
			    <td width="87" height="30" align="center"><div align="center" class="style6"><strong>PID</strong></div></td>
              <td width="93" height="30" align="center"><div align="center" class="style6"><strong>Product Name</strong></div></td>
              <td width="107"><div align="center" class="style6"><strong>Price</strong></div></td>
          <td width="83"><div align="center" class="style6"><strong>Discount</strong></div></td>
		    <td width="100" align="center"><div align="center" class="style6"><strong>Amount</strong></div></td>
              <td width="99"><div align="center" class="style6"><strong>No of Product</strong></div></td>
			     <td width="132"><div align="center" class="style6"><strong>Total Amount</strong></div></td>
          <td width="127"><div align="center" class="style6"><strong>Date</strong></div></td>
            </tr>
 ...
 System.out.println(a11);
		...
		ResultSet rs = st.executeQuery("select * from purchase where uname='"+so.getAttribute("un")+"' ");
    ...
    while(rs.next())
	 ...
	 %>
            <tr>
			<td width="87" height="36" align="center"><div align="center"><%=rs.getString(1)%></div></td>
			    <td width="93" height="36" align="center"><div align="center"><%=rs.getString(5)%></div></td>
              <td width="107"><div align="center"><%=rs.getString(6)%></div></td>
          <td width="83"><div align="center"><%=rs.getString(7)%></div></td>
              <td width="100" align="center"><div align="center"><%=rs.getString(8)%></div></td>
              <td width="99"><div align="center"><%=rs.getString(9)%></div></td>
          <td width="132"><div align="center"><%=rs.getString(10)%></div></td>
		   <td width="127"><div align="center"><%=rs.getString(11)%></div></td>
            </tr><%
