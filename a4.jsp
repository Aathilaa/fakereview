    ...
    <div class="block_header">
      ...
      <div class="menu">
        <ul>
          ...
          <li><a href="a4.jsp"  class="active">Customer</a></li>
...
Xperia™ smartphones, tablets and accessories are packed full of intelligent Sony technology to enhance your world and get the most out of every moment that life brings. <a href="#"></a></p>
  ...
  <div class="body">
    ...
    <div class="body_resize">
      <div class="Welcome" style="width: 920px; font-size: 12px; font-weight: bold;">
        <h2>&nbsp;</h2>
        <FORM action="" method="post">
     <table width="650" border="1" align="center" bordercolor="#006699">
        <tr>
          <td width="652" height="35" align="center"><span class="style2"><span class="style3 style2"><strong>CUSTOMER DETAILS </span></td>
        </tr>
        <tr>
          <td height="84" align="center"><table width="644" height="36" border="1" bordercolor="#006699">
  <tr>
			   
              <td width="109" height="30" align="center"><span class="style1">Name</span></td>
              <td width="109" align="center"><span class="style1">Address</span></td>
              <td width="119" align="center"><span class="style1">Contact</span></td>
		      <td width="155" align="center"><span class="style1">Email</span></td>
              <td width="130" align="center"><span class="style1">Gender</span></td>
            </tr>
 ...
 System.out.println(a11);
    ...
    while(rs.next())
	 ...
	 %>
            <tr>
			    <td width="112" height="36" align="center"><div align="center"><%=rs.getString(3)%></div></td>
              <td width="107"><div align="center"><%=rs.getString(4)%></div></td>
          <td width="116"><div align="center"><%=rs.getString(5)%></div></td>
              <td width="153" align="center"><div align="center"><%=rs.getString(6)%></div></td>
              <td width="134"><div align="center"><%=rs.getString(7)%></div></td>
            </tr><%
