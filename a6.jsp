...
Xperia™ smartphones, tablets and accessories are packed full of intelligent Sony technology to enhance your world and get the most out of every moment that life brings. <a href="#"></a></p>
  ...
  <div class="body">
    ...
    <div class="body_resize">
     ...
     <table width="859" border="1" align="center" bordercolor="#003399">
        <tr>
          <td width="853" height="35" align="center"><strong>FEEDBACK DETAILS</strong></td>
        </tr>
        <tr>
          <td align="center"><table width="892" height="36" border="1" bordercolor="#003399">
  <tr>
			   
              <td width="78" height="30" align="center"><div align="center" class="style3 style6"><strong>Fid</strong></div></td>
              <td width="63"><div align="center" class="style3 style6"><strong>Pid</strong></div></td>
          <td width="64"><div align="center" class="style3 style6"><strong>Pname</strong></div></td>
		    <td width="65" align="center"><div align="center" class="style3 style6"><strong>Name</strong></div></td>
              <td width="117"><div align="center" class="style3 style6"><strong>Rate</strong></div></td>
			     <td width="232"><div align="center" class="style3 style6"><strong>Feed</strong></div></td>
          <td width="90"><div align="center" class="style3 style6"><strong>Ip Address </strong></div></td>
          <td width="110"><div align="center" class="style3 style6"><strong>Status </strong></div></td>
            </tr>
 ...
 System.out.println(a11);
    ...
    while(rs.next())
	 ...
	 %>
            <tr>
			    <td width="78" height="36" align="center"><div align="center"><%=rs.getString(1)%></div></td>
              <td width="63"><div align="center"><%=rs.getString(2)%></div></td>
          <td width="64"><div align="center"><%=rs.getString(3)%></div></td>
              <td width="65" align="center"><div align="center"><%=rs.getString(7)%></div></td>
              <td width="117"><div align="center"><%=rs.getString(5)%></div></td>
          <td width="232"><div align="center"><%=rs.getString(8)%></div></td>
		   <td width="90"><div align="center"><%=rs.getString(9)%></div></td>
                  <td width="110"><div align="center"><%=rs.getString(10)%></div></td>
            </tr><%
